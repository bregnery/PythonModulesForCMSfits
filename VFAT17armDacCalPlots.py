...
vfatID = ["vfatN0_vfatID6471", "vfatN1_vfatID6135", "vfatN2_vfatID6309", "vfatN3_vfatID6327", "vfatN4_vfatID6329", 
          ...
          "vfatN20_vfatID6428", "vfatN21_vfatID6152", "vfatN22_vfatID6378", "vfatN23_vfatID6140"]

# Get Scurve Ensemble Mean and Sigma for VFAT 17, ID 6137, threshold DAC 17
ensMean = []
ensSigma = []
for ifile in fileList :
   meanDistr = ifile.Get("VFAT17/RawData/ScurveMean/gScurveMeanDist_vfatN17_vfatID6137_thrDAC17.0")
   sigmaDistr = ifile.Get("VFAT17/RawData/ScurveSigma/gScurveSigmaDist_vfatN17_vfatID6137_thrDAC17.0")
   ensMean.append(meanDistr.GetMean() )
   ensSigma.append(sigmaDistr.GetMean() )
