...
nctMu26for110to310ExponcncHist = root.TH1F("nctMu26for110to310ExponcncHist","Cross Section for NLO CT ncnc",100,110,310)
settings.setHistTitles(nctMu26for110to310ExponcncHist, "Dimuon Mass [GeV/c^{2}]", "Cross Section")

nctMu26for110to310ChebyshevncncHist = root.TH1F("nctMu26for110to310ChebyshevncncHist","Cross Section for NLO CT ncnc",100,110,310)
settings.setHistTitles(nctMu26for110to310ChebyshevncncHist, "Dimuon Mass [GeV/c^{2}]", "Cross Section")

nctMu26for110to310DimitrincncHist = root.TH1F("nctMu26for110to310DimitrincncHist","Cross Section for NLO CT ncnc",100,110,310)
settings.setHistTitles(nctMu26for110to310DimitrincncHist, "Dimuon Mass [GeV/c^{2}]", "Cross Section")

nctMu26for110to310BwExponcncHist = root.TH1F("nctMu26for110to310BwExponcncHist","Cross Section for NLO CT ncnc",100,110,310)
settings.setHistTitles(nctMu26for110to310BwExponcncHist, "Dimuon Mass [GeV/c^{2}]", "Cross Section")

nctMu26for110to310RelBwExponcncHist = root.TH1F("nctMu26for110to310RelBwExponcncHist","Cross Section for NLO CT ncnc",100,110,310)
settings.setHistTitles(nctMu26for110to310RelBwExponcncHist, "Dimuon Mass [GeV/c^{2}]", "Cross Section")

nctMu26for110to310PerExpoBwncncHist = root.TH1F("nctMu26for110to310PerExpoBwncncHist","Cross Section for NLO CT ncnc",100,110,310)
settings.setHistTitles(nctMu26for110to310PerExpoBwncncHist, "Dimuon Mass [GeV/c^{2}]", "Cross Section")

nctMu26for110to310PerExpoRelBwncncHist = root.TH1F("nctMu26for110to310PerExpoRelBwncncHist","Cross Section for NLO CT ncnc",100,110,310)
settings.setHistTitles(nctMu26for110to310PerExpoRelBwncncHist, "Dimuon Mass [GeV/c^{2}]", "Cross Section")

nctMu26for110to310DimitriRelBwncncHist = root.TH1F("nctMu26for110to310DimitriRelBwncncHist","Cross Section for NLO CT ncnc",100,110,310)
settings.setHistTitles(nctMu26for110to310DimitriRelBwncncHist, "Dimuon Mass [GeV/c^{2}]", "Cross Section")

nctMu26for110to310ModDimitriRelBwncncHist = root.TH1F("nctMu26for110to310ModDimitriRelBwncncHist","Cross Section for NLO CT ncnc",100,110,310)
...
perExpoRelBwParameters = numpy.array([1100000, 1.87, 3, -0.8])
dimitriRelBwParameters = numpy.array([1100, 1.65, -0.7])
...
fitfuncChebyshev = fit.fitTH1(nctMu26for110to310ChebyshevncncHist, 110, 310, chebyshevParameters, pdf.chebyshev, "R", root.kRed)  
